      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            ...
            <p
              lang="bn"
              className="font-bengali mt-3 text-sm text-white/60 leading-relaxed"
            >
              {TAGLINE_BN}
            </p>
          </div>
          ...
          <div>
            <h3
              lang={language}
              className={`${fontClass} mb-4 text-xs font-semibold uppercase tracking-widest text-white/40`}
            >
              {t("footer.services")}
            </h3>
